        ...
        <div class="content-wrapper">
            <div class="page-header enhanced-page-header">
                <div class="header-content">
                    <h3 class="page-title enhanced-page-title">Prospectus Report</h3>
            ...
            <div class="report-section">
                <div class="dropdown-container">
                    <div class="dropdown mb-3">
                        ...
                        <button id="generatePDF" class="btn btn-success" style="display: none;"><i class="bi bi-filetype-pdf"></i> Generate Prospectus</button>
...
$(document).ready(function() {
    ...
    function fetchProspectus(courseId, effectiveYear) {
        ...
        $.ajax({
            url: './functions/fetch-prospectus.php',
            method: 'POST',
