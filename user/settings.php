...
if (isset($_POST['change_password'])) {
    ...
    if ($new_password != $confirm_password) {
        ...
        $sql = "SELECT user_id FROM users WHERE user_id=:userid AND password=:current_password";
        ...
        if ($query->rowCount() > 0) {
            ...
            $update_query->bindParam(':userid', $userid, PDO::PARAM_STR);
...
<head>
    ...
    <link rel="icon" type="image/png" href="..//user/favicon_io/android-chrome-192x192.png">
